...
import com.alura.foro.forohub.domain.curso.*;
...
public class ControllerCurso {
    ...
    public ResponseEntity<DetalleCursoDTO> actualizarCurso(@RequestBody @Valid UpdateCursoDTO actualizarCursoDTO, @PathVariable Long id){
