...
import com.alura.foro.forohub.domain.respuesta.DTODetalleRespuesta;
...
import com.alura.foro.forohub.domain.topico.*;
import com.alura.foro.forohub.domain.topico.validaciones.actualizar.ValidarTopicoActualizado;
import com.alura.foro.forohub.domain.topico.validaciones.crear.ValidarTopicoCreado;
...
public class ControllerTopico {
    ...
    public ResponseEntity<DTODetalleRespuesta> leerSolucionTopico(@PathVariable Long id){
